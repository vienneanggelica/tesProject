...
def input_post():
    args1 = request.args.get("id") #diterima di sini
    args2 = request.args.get("nik")
    args3 = request.args.get("nama")
    args4 = request.args.get("alamat")
    args5 = request.args.get("gaji")
    args6 = request.args.get("pekerjaan")
    args7 = request.args.get("tanggungan")
    args8 = request.args.get("umur")
    args9 = request.args.get("status")
    input_predict = np.array([args5 + args6 + args7 + args8])
